...
function concordance() {
    ...
    var insertaudio="<audioFilePosition id=\"AudioNaija\" style=\"background-color: #2fcf2d;color:black\"><small>(clic sur un mot : lecture fichier audio)</small></audioFilePosition><p><hr/></p>";
    //$("#placeholder").html("");
